...
const AboutMe = () => {
  ...
  const skills =
    "My core tech stack includes JavaScript, Java, SQL; I am experienced in front end frameworks like React, as well as back end frameworks such as Express.js and Spring Boot. Along with coding, I have years of experience in graphic design software such as Adobe Photoshop.";
  const experience =
  ...
  return (
    <div id={styles["about-me"]}>
      ...
      <TextCard title="My Skills" body={skills} />
